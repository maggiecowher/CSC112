 ...
 * </p>
 * This class creates the shopping cart using a stack. The stack class has a push(), pop(), and peek() method. The
 * push() method adds the top of the stack, the pop() method removes from the top of the stack and returns that element,
